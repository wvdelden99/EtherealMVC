...
@section('title')
    <title>Ethereal - Space</title>
@endsection

@section('content')
    <div class="plg-cont-top">
        <img class="plg-cont-top_img-effect" src="{{asset('img/space-effect-bg.png')}}">
        ...
        <div class="plg-cont-top_title-box">
            <div class="plg-cont-top_row">
                <div class="plg-cont-top_title">
                    <img src="{{asset('img/space-icon.png')}}">
                    <h1>space</h1>
                </div>
        ...
        <div class="plg-cont-mid3 fade-in" id="mid3">
            <div class="plg-cont-mid3_txt-box">
                <div class="plg-cont-mid3_txt">
                    ...
                    <p>Space can be bought seperate or in bundle with other plugins</p>
                </div>
            ...
            <div class="plg-cont-mid3-option">
                <div class="plg-cont-mid3-box">
                    <div class="plg-cont-mid3-top">
                        <img src="{{asset('img/space-icon-000.png')}}">
                        <h1 class="plg-cont-mid3_title">space</h1>
                    </div>
